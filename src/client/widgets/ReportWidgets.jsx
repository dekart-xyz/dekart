...
export default function ReportWidgets ({ visible, editing, presentationPending, dataReloadPending, onOpenData }) {
  ...
  const { sources, readySources } = useWidgetSources({ store, report, initialized, datasetList, tables, jobs, localJobs, paramsHash, downloads, setError })
  ...
  useEffect(() => {
    ...
    adoptWidgetsConfig(store, adoption, widgets.config, datasetIds, editing, dispatch)
