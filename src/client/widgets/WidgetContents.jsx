...
function WidgetBuilder ({ store, datasetId, onCreated }) {
  ...
  return <ChartBuilderRoot open={false} tableName={widgetTableName(datasetId)} columns={table?.columns || []} chartTypes={chartTypes} onCreateChart={create}><ChartBuilderContent /></ChartBuilderRoot>
}
