...
function WelcomeScreen ({ setNextStep }) {
  ...
  return (
    <Result
      ...
      // icon={<RocketTwoTone />}
      title='Get started!'
      subTitle="Let's find you a workspace to create your first private report"
      extra={(
        <>
          ...
          <div className={styles.playground} onClick={() => dispatch(switchPlayground(true))}><Button type='link'>Switch to Public Playground</Button></div>
        </>
             )}
    />
  )
