...
function Kepler ({ snapshot, interactionDisabled, onSnapshotBasemapReadyChange }) {
  ...
  const handleSidePanelInteraction = event => {
  ...
  return (
    <div
      ...
      onClickCapture={handleSidePanelInteraction}
      onKeyDownCapture={handleSidePanelInteraction}
      onPointerDownCapture={handleSidePanelInteraction}
    >
      {!snapshot
        ? (
      ...
      <div className={classnames(styles.body, { [styles.snapshotBody]: snapshot })}>
        ...
        <div className={classnames(styles.keplerFlexWrapper, { [styles.hideMapSettings]: leftPanel !== 'map' || !paneOpen })}>
          <div className={styles.keplerFlex}>
            ...
            {!snapshot && <FilterStrip visible={paneOpen && leftPanel === 'widgets'} editing={edit && report.canWrite && !readOnly} disabled={queriesRunning} onEdit={editFilter} onApply={applyWidgetMapChange} />}
