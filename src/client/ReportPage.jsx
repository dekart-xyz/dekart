      ...
      <div className={classnames(styles.body, { [styles.snapshotBody]: snapshot })}>
        ...
        <div className={classnames(styles.keplerFlexWrapper, { [styles.hideMapSettings]: leftPanel !== 'map' || !paneOpen })}>
          <div className={styles.keplerFlex}>
            ...
            {!snapshot && <Suspense fallback={null}><ReportWidgets key={id} visible={paneOpen && leftPanel === 'widgets'} presentationPending={widgetFilterPending} editing={edit && report.canWrite && !readOnly} onOpenData={() => document.getElementById('dekart-report-page-tabs')?.scrollIntoView({ block: 'nearest' })} /></Suspense>}
            <Kepler
              snapshot={snapshot}
