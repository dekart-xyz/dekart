...
var file_proto_dekart_proto_rawDesc = []byte{
	...
	0x28, 0x08, 0x52, 0x08, 0x63, 0x61, 0x6e, 0x57, 0x72, 0x69, 0x74, 0x65, 0x22, 0x8f, 0x01, 0x0a,
	...
	0x01, 0x28, 0x03, 0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xdc,
	...
	0x52, 0x43, 0x45, 0x5f, 0x53, 0x54, 0x4f, 0x52, 0x41, 0x47, 0x45, 0x10, 0x02, 0x22, 0x54, 0x0a,
	...
	0x6e, 0x73, 0x65, 0x22, 0x33, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x51, 0x75, 0x65,
	...
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xb6, 0x01, 0x0a,
	...
	0x61, 0x73, 0x65, 0x74, 0x73, 0x22, 0x30, 0x0a, 0x11, 0x46, 0x6f, 0x72, 0x6b, 0x52, 0x65, 0x70,
	...
	0x72, 0x74, 0x52, 0x06, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x32, 0xdd, 0x06, 0x0a, 0x06, 0x44,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x0b, 0x52, 0x65, 0x6d,
	0x6f, 0x76, 0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x13, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76,
	0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e,
	0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_proto_dekart_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_proto_dekart_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_proto_dekart_proto_goTypes = []interface{}{
	...
	(*RemoveDatasetRequest)(nil),      // 3: RemoveDatasetRequest
	(*RemoveDatasetResponse)(nil),     // 4: RemoveDatasetResponse
	(*StreamOptions)(nil),             // 5: StreamOptions
	(*GetEnvRequest)(nil),             // 6: GetEnvRequest
	(*GetEnvResponse)(nil),            // 7: GetEnvResponse
	(*ArchiveReportRequest)(nil),      // 8: ArchiveReportRequest
	(*ArchiveReportResponse)(nil),     // 9: ArchiveReportResponse
	(*ReportListRequest)(nil),         // 10: ReportListRequest
	(*ReportListResponse)(nil),        // 11: ReportListResponse
	(*Report)(nil),                    // 12: Report
	(*Dataset)(nil),                   // 13: Dataset
	(*Query)(nil),                     // 14: Query
	(*UpdateReportRequest)(nil),       // 15: UpdateReportRequest
	(*UpdateReportResponse)(nil),      // 16: UpdateReportResponse
	(*RunQueryRequest)(nil),           // 17: RunQueryRequest
	(*RunQueryResponse)(nil),          // 18: RunQueryResponse
	(*RemoveQueryRequest)(nil),        // 19: RemoveQueryRequest
	(*RemoveQueryResponse)(nil),       // 20: RemoveQueryResponse
	(*CancelQueryRequest)(nil),        // 21: CancelQueryRequest
	(*CancelQueryResponse)(nil),       // 22: CancelQueryResponse
	(*UpdateQueryRequest)(nil),        // 23: UpdateQueryRequest
	(*UpdateQueryResponse)(nil),       // 24: UpdateQueryResponse
	(*CreateDatasetRequest)(nil),      // 25: CreateDatasetRequest
	(*CreateDatasetResponse)(nil),     // 26: CreateDatasetResponse
	(*CreateQueryRequest)(nil),        // 27: CreateQueryRequest
	(*CreateQueryResponse)(nil),       // 28: CreateQueryResponse
	(*ReportStreamRequest)(nil),       // 29: ReportStreamRequest
	(*ReportStreamResponse)(nil),      // 30: ReportStreamResponse
	(*ForkReportRequest)(nil),         // 31: ForkReportRequest
	(*ForkReportResponse)(nil),        // 32: ForkReportResponse
	(*CreateReportRequest)(nil),       // 33: CreateReportRequest
	(*CreateReportResponse)(nil),      // 34: CreateReportResponse
	(*GetEnvResponse_Variable)(nil),   // 35: GetEnvResponse.Variable
}
var file_proto_dekart_proto_depIdxs = []int32{
	35, // 0: GetEnvResponse.variables:type_name -> GetEnvResponse.Variable
	5,  // 1: ReportListRequest.stream_options:type_name -> StreamOptions
	12, // 2: ReportListResponse.reports:type_name -> Report
	5,  // 3: ReportListResponse.stream_options:type_name -> StreamOptions
	1,  // 4: Query.job_status:type_name -> Query.JobStatus
	2,  // 5: Query.query_source:type_name -> Query.QuerySource
	12, // 6: UpdateReportRequest.report:type_name -> Report
	14, // 7: UpdateReportRequest.query:type_name -> Query
	14, // 8: UpdateQueryRequest.query:type_name -> Query
	14, // 9: UpdateQueryResponse.query:type_name -> Query
	14, // 10: CreateQueryResponse.query:type_name -> Query
	12, // 11: ReportStreamRequest.report:type_name -> Report
	5,  // 12: ReportStreamRequest.stream_options:type_name -> StreamOptions
	12, // 13: ReportStreamResponse.report:type_name -> Report
	14, // 14: ReportStreamResponse.queries:type_name -> Query
	5,  // 15: ReportStreamResponse.stream_options:type_name -> StreamOptions
	13, // 16: ReportStreamResponse.datasets:type_name -> Dataset
	12, // 17: CreateReportResponse.report:type_name -> Report
	0,  // 18: GetEnvResponse.Variable.type:type_name -> GetEnvResponse.Variable.Type
	33, // 19: Dekart.CreateReport:input_type -> CreateReportRequest
	31, // 20: Dekart.ForkReport:input_type -> ForkReportRequest
	15, // 21: Dekart.UpdateReport:input_type -> UpdateReportRequest
	8,  // 22: Dekart.ArchiveReport:input_type -> ArchiveReportRequest
	25, // 23: Dekart.CreateDataset:input_type -> CreateDatasetRequest
	3,  // 24: Dekart.RemoveDataset:input_type -> RemoveDatasetRequest
	27, // 25: Dekart.CreateQuery:input_type -> CreateQueryRequest
	23, // 26: Dekart.UpdateQuery:input_type -> UpdateQueryRequest
	17, // 27: Dekart.RunQuery:input_type -> RunQueryRequest
	21, // 28: Dekart.CancelQuery:input_type -> CancelQueryRequest
	19, // 29: Dekart.RemoveQuery:input_type -> RemoveQueryRequest
	6,  // 30: Dekart.GetEnv:input_type -> GetEnvRequest
	29, // 31: Dekart.GetReportStream:input_type -> ReportStreamRequest
	10, // 32: Dekart.GetReportListStream:input_type -> ReportListRequest
	34, // 33: Dekart.CreateReport:output_type -> CreateReportResponse
	32, // 34: Dekart.ForkReport:output_type -> ForkReportResponse
	16, // 35: Dekart.UpdateReport:output_type -> UpdateReportResponse
	9,  // 36: Dekart.ArchiveReport:output_type -> ArchiveReportResponse
	26, // 37: Dekart.CreateDataset:output_type -> CreateDatasetResponse
	4,  // 38: Dekart.RemoveDataset:output_type -> RemoveDatasetResponse
	28, // 39: Dekart.CreateQuery:output_type -> CreateQueryResponse
	24, // 40: Dekart.UpdateQuery:output_type -> UpdateQueryResponse
	18, // 41: Dekart.RunQuery:output_type -> RunQueryResponse
	22, // 42: Dekart.CancelQuery:output_type -> CancelQueryResponse
	20, // 43: Dekart.RemoveQuery:output_type -> RemoveQueryResponse
	7,  // 44: Dekart.GetEnv:output_type -> GetEnvResponse
	30, // 45: Dekart.GetReportStream:output_type -> ReportStreamResponse
	11, // 46: Dekart.GetReportListStream:output_type -> ReportListResponse
