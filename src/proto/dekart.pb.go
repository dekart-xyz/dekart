...
var file_proto_dekart_proto_rawDesc = []byte{
	...
	0x69, 0x65, 0x77, 0x65, 0x72, 0x73, 0x32, 0x34, 0x68, 0x22, 0xa4, 0x06, 0x0a, 0x06, 0x52, 0x65,
...
var file_proto_dekart_proto_depIdxs = []int32{
	...
	101, // 45: UpdateReportRequest.query:type_name -> Query
	123, // 46: UpdateReportRequest.query_params:type_name -> QueryParam
	96,  // 47: UpdateReportRequest.readme:type_name -> Readme
	123, // 48: RunQueryRequest.query_params:type_name -> QueryParam
	101, // 49: CreateQueryResponse.query:type_name -> Query
	98,  // 50: ReportStreamRequest.report:type_name -> Report
	87,  // 51: ReportStreamRequest.stream_options:type_name -> StreamOptions
	98,  // 52: ReportStreamResponse.report:type_name -> Report
	101, // 53: ReportStreamResponse.queries:type_name -> Query
	87,  // 54: ReportStreamResponse.stream_options:type_name -> StreamOptions
	99,  // 55: ReportStreamResponse.datasets:type_name -> Dataset
	102, // 56: ReportStreamResponse.files:type_name -> File
	100, // 57: ReportStreamResponse.query_jobs:type_name -> QueryJob
	98,  // 58: CreateReportResponse.report:type_name -> Report
	11,  // 59: QueryParam.type:type_name -> QueryParam.Type
	6,   // 60: GetEnvResponse.Variable.type:type_name -> GetEnvResponse.Variable.Type
	121, // 61: Dekart.CreateReport:input_type -> CreateReportRequest
	119, // 62: Dekart.ForkReport:input_type -> ForkReportRequest
	103, // 63: Dekart.UpdateReport:input_type -> UpdateReportRequest
	92,  // 64: Dekart.ArchiveReport:input_type -> ArchiveReportRequest
	83,  // 65: Dekart.SetDiscoverable:input_type -> SetDiscoverableRequest
	39,  // 66: Dekart.PublishReport:input_type -> PublishReportRequest
	35,  // 67: Dekart.AllowExportDatasets:input_type -> AllowExportDatasetsRequest
	31,  // 68: Dekart.AddReadme:input_type -> AddReadmeRequest
	33,  // 69: Dekart.RemoveReadme:input_type -> RemoveReadmeRequest
	27,  // 70: Dekart.AddReportDirectAccess:input_type -> AddReportDirectAccessRequest
	21,  // 71: Dekart.SetTrackViewers:input_type -> SetTrackViewersRequest
	25,  // 72: Dekart.SetAutoRefreshIntervalSeconds:input_type -> SetAutoRefreshIntervalSecondsRequest
	16,  // 73: Dekart.GetSnapshots:input_type -> GetSnapshotsRequest
	14,  // 74: Dekart.RestoreReportSnapshot:input_type -> RestoreReportSnapshotRequest
	12,  // 75: Dekart.SaveMapPreview:input_type -> SaveMapPreviewRequest
	111, // 76: Dekart.CreateDataset:input_type -> CreateDatasetRequest
	85,  // 77: Dekart.RemoveDataset:input_type -> RemoveDatasetRequest
	107, // 78: Dekart.UpdateDatasetName:input_type -> UpdateDatasetNameRequest
	109, // 79: Dekart.UpdateDatasetConnection:input_type -> UpdateDatasetConnectionRequest
	113, // 80: Dekart.CreateFile:input_type -> CreateFileRequest
	115, // 81: Dekart.CreateQuery:input_type -> CreateQueryRequest
	105, // 82: Dekart.RunQuery:input_type -> RunQueryRequest
	61,  // 83: Dekart.RunAllQueries:input_type -> RunAllQueriesRequest
	37,  // 84: Dekart.CancelJob:input_type -> CancelJobRequest
	88,  // 85: Dekart.GetEnv:input_type -> GetEnvRequest
	117, // 86: Dekart.GetReportStream:input_type -> ReportStreamRequest
	94,  // 87: Dekart.GetReportListStream:input_type -> ReportListRequest
	69,  // 88: Dekart.GetUserStream:input_type -> GetUserStreamRequest
	81,  // 89: Dekart.GetUsage:input_type -> GetUsageRequest
	29,  // 90: Dekart.GetReportAnalytics:input_type -> GetReportAnalyticsRequest
	19,  // 91: Dekart.TrackEvent:input_type -> TrackEventRequest
	77,  // 92: Dekart.CreateConnection:input_type -> CreateConnectionRequest
	57,  // 93: Dekart.GetGcpProjectList:input_type -> GetGcpProjectListRequest
	75,  // 94: Dekart.UpdateConnection:input_type -> UpdateConnectionRequest
	73,  // 95: Dekart.ArchiveConnection:input_type -> ArchiveConnectionRequest
	67,  // 96: Dekart.GetConnectionList:input_type -> GetConnectionListRequest
	71,  // 97: Dekart.TestConnection:input_type -> TestConnectionRequest
	59,  // 98: Dekart.SetDefaultConnection:input_type -> SetDefaultConnectionRequest
	23,  // 99: Dekart.GetWherobotsConnectionHint:input_type -> GetWherobotsConnectionHintRequest
	51,  // 100: Dekart.RespondToInvite:input_type -> RespondToInviteRequest
	65,  // 101: Dekart.CreateSubscription:input_type -> CreateSubscriptionRequest
	41,  // 102: Dekart.GetStripePortalSession:input_type -> GetStripePortalSessionRequest
	47,  // 103: Dekart.CreateWorkspace:input_type -> CreateWorkspaceRequest
	49,  // 104: Dekart.UpdateWorkspace:input_type -> UpdateWorkspaceRequest
	45,  // 105: Dekart.GetWorkspace:input_type -> GetWorkspaceRequest
	43,  // 106: Dekart.UpdateWorkspaceUser:input_type -> UpdateWorkspaceUserRequest
	122, // 107: Dekart.CreateReport:output_type -> CreateReportResponse
	120, // 108: Dekart.ForkReport:output_type -> ForkReportResponse
	104, // 109: Dekart.UpdateReport:output_type -> UpdateReportResponse
	93,  // 110: Dekart.ArchiveReport:output_type -> ArchiveReportResponse
	84,  // 111: Dekart.SetDiscoverable:output_type -> SetDiscoverableResponse
	40,  // 112: Dekart.PublishReport:output_type -> PublishReportResponse
	36,  // 113: Dekart.AllowExportDatasets:output_type -> AllowExportDatasetsResponse
	32,  // 114: Dekart.AddReadme:output_type -> AddReadmeResponse
	34,  // 115: Dekart.RemoveReadme:output_type -> RemoveReadmeResponse
	28,  // 116: Dekart.AddReportDirectAccess:output_type -> AddReportDirectAccessResponse
	22,  // 117: Dekart.SetTrackViewers:output_type -> SetTrackViewersResponse
	26,  // 118: Dekart.SetAutoRefreshIntervalSeconds:output_type -> SetAutoRefreshIntervalSecondsResponse
	18,  // 119: Dekart.GetSnapshots:output_type -> GetSnapshotsResponse
	15,  // 120: Dekart.RestoreReportSnapshot:output_type -> RestoreReportSnapshotResponse
	13,  // 121: Dekart.SaveMapPreview:output_type -> SaveMapPreviewResponse
	112, // 122: Dekart.CreateDataset:output_type -> CreateDatasetResponse
	86,  // 123: Dekart.RemoveDataset:output_type -> RemoveDatasetResponse
	108, // 124: Dekart.UpdateDatasetName:output_type -> UpdateDatasetNameResponse
	110, // 125: Dekart.UpdateDatasetConnection:output_type -> UpdateDatasetConnectionResponse
	114, // 126: Dekart.CreateFile:output_type -> CreateFileResponse
	116, // 127: Dekart.CreateQuery:output_type -> CreateQueryResponse
	106, // 128: Dekart.RunQuery:output_type -> RunQueryResponse
	62,  // 129: Dekart.RunAllQueries:output_type -> RunAllQueriesResponse
	38,  // 130: Dekart.CancelJob:output_type -> CancelJobResponse
	89,  // 131: Dekart.GetEnv:output_type -> GetEnvResponse
	118, // 132: Dekart.GetReportStream:output_type -> ReportStreamResponse
	95,  // 133: Dekart.GetReportListStream:output_type -> ReportListResponse
	70,  // 134: Dekart.GetUserStream:output_type -> GetUserStreamResponse
	82,  // 135: Dekart.GetUsage:output_type -> GetUsageResponse
	30,  // 136: Dekart.GetReportAnalytics:output_type -> GetReportAnalyticsResponse
	20,  // 137: Dekart.TrackEvent:output_type -> TrackEventResponse
	78,  // 138: Dekart.CreateConnection:output_type -> CreateConnectionResponse
	58,  // 139: Dekart.GetGcpProjectList:output_type -> GetGcpProjectListResponse
	76,  // 140: Dekart.UpdateConnection:output_type -> UpdateConnectionResponse
	74,  // 141: Dekart.ArchiveConnection:output_type -> ArchiveConnectionResponse
	68,  // 142: Dekart.GetConnectionList:output_type -> GetConnectionListResponse
	72,  // 143: Dekart.TestConnection:output_type -> TestConnectionResponse
	60,  // 144: Dekart.SetDefaultConnection:output_type -> SetDefaultConnectionResponse
	24,  // 145: Dekart.GetWherobotsConnectionHint:output_type -> GetWherobotsConnectionHintResponse
	52,  // 146: Dekart.RespondToInvite:output_type -> RespondToInviteResponse
	66,  // 147: Dekart.CreateSubscription:output_type -> CreateSubscriptionResponse
	42,  // 148: Dekart.GetStripePortalSession:output_type -> GetStripePortalSessionResponse
	48,  // 149: Dekart.CreateWorkspace:output_type -> CreateWorkspaceResponse
	50,  // 150: Dekart.UpdateWorkspace:output_type -> UpdateWorkspaceResponse
	46,  // 151: Dekart.GetWorkspace:output_type -> GetWorkspaceResponse
	44,  // 152: Dekart.UpdateWorkspaceUser:output_type -> UpdateWorkspaceUserResponse
	107, // [107:153] is the sub-list for method output_type
	61,  // [61:107] is the sub-list for method input_type
