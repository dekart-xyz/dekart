...
var file_proto_dekart_proto_rawDesc = []byte{
	...
	0x52, 0x41, 0x47, 0x45, 0x10, 0x02, 0x22, 0xb6, 0x01, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12,
	...
	0x0a, 0x12, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x71,
	...
	0x15, 0x0a, 0x13, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x2f, 0x0a, 0x12, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c,
	...
	0x71, 0x75, 0x65, 0x72, 0x79, 0x49, 0x64, 0x22, 0x15, 0x0a, 0x13, 0x43, 0x61, 0x6e, 0x63, 0x65,
	0x6c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x32,
	0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x06, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x05, 0x71, 0x75, 0x65,
	0x72, 0x79, 0x22, 0x33, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x51, 0x75, 0x65, 0x72,
	...
	0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0x33, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x73, 0x22, 0xd3, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x74, 0x72, 0x65,
	...
	0x52, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x30, 0x0a, 0x11, 0x46, 0x6f, 0x72, 0x6b, 0x52,
	...
	0x70, 0x6f, 0x72, 0x74, 0x52, 0x06, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x32, 0x96, 0x07, 0x0a,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x0b, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x12, 0x13, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76,
...
var file_proto_dekart_proto_goTypes = []interface{}{
	...
	(*Query)(nil),                     // 14: Query
	(*File)(nil),                      // 15: File
	(*UpdateReportRequest)(nil),       // 16: UpdateReportRequest
	(*UpdateReportResponse)(nil),      // 17: UpdateReportResponse
	(*RunQueryRequest)(nil),           // 18: RunQueryRequest
	(*RunQueryResponse)(nil),          // 19: RunQueryResponse
	(*RemoveQueryRequest)(nil),        // 20: RemoveQueryRequest
	(*RemoveQueryResponse)(nil),       // 21: RemoveQueryResponse
	(*CancelQueryRequest)(nil),        // 22: CancelQueryRequest
	(*CancelQueryResponse)(nil),       // 23: CancelQueryResponse
	(*UpdateQueryRequest)(nil),        // 24: UpdateQueryRequest
	(*UpdateQueryResponse)(nil),       // 25: UpdateQueryResponse
	(*CreateDatasetRequest)(nil),      // 26: CreateDatasetRequest
	(*CreateDatasetResponse)(nil),     // 27: CreateDatasetResponse
	(*CreateFileRequest)(nil),         // 28: CreateFileRequest
	(*CreateFileResponse)(nil),        // 29: CreateFileResponse
	(*CreateQueryRequest)(nil),        // 30: CreateQueryRequest
	(*CreateQueryResponse)(nil),       // 31: CreateQueryResponse
	(*ReportStreamRequest)(nil),       // 32: ReportStreamRequest
	(*ReportStreamResponse)(nil),      // 33: ReportStreamResponse
	(*ForkReportRequest)(nil),         // 34: ForkReportRequest
	(*ForkReportResponse)(nil),        // 35: ForkReportResponse
	(*CreateReportRequest)(nil),       // 36: CreateReportRequest
	(*CreateReportResponse)(nil),      // 37: CreateReportResponse
	(*GetEnvResponse_Variable)(nil),   // 38: GetEnvResponse.Variable
}
var file_proto_dekart_proto_depIdxs = []int32{
	38, // 0: GetEnvResponse.variables:type_name -> GetEnvResponse.Variable
	...
	15, // 17: ReportStreamResponse.files:type_name -> File
	12, // 18: CreateReportResponse.report:type_name -> Report
	0,  // 19: GetEnvResponse.Variable.type:type_name -> GetEnvResponse.Variable.Type
	36, // 20: Dekart.CreateReport:input_type -> CreateReportRequest
	34, // 21: Dekart.ForkReport:input_type -> ForkReportRequest
	16, // 22: Dekart.UpdateReport:input_type -> UpdateReportRequest
	8,  // 23: Dekart.ArchiveReport:input_type -> ArchiveReportRequest
	26, // 24: Dekart.CreateDataset:input_type -> CreateDatasetRequest
	3,  // 25: Dekart.RemoveDataset:input_type -> RemoveDatasetRequest
	28, // 26: Dekart.CreateFile:input_type -> CreateFileRequest
	30, // 27: Dekart.CreateQuery:input_type -> CreateQueryRequest
	24, // 28: Dekart.UpdateQuery:input_type -> UpdateQueryRequest
	18, // 29: Dekart.RunQuery:input_type -> RunQueryRequest
	22, // 30: Dekart.CancelQuery:input_type -> CancelQueryRequest
	20, // 31: Dekart.RemoveQuery:input_type -> RemoveQueryRequest
	6,  // 32: Dekart.GetEnv:input_type -> GetEnvRequest
	32, // 33: Dekart.GetReportStream:input_type -> ReportStreamRequest
	10, // 34: Dekart.GetReportListStream:input_type -> ReportListRequest
	37, // 35: Dekart.CreateReport:output_type -> CreateReportResponse
	35, // 36: Dekart.ForkReport:output_type -> ForkReportResponse
	17, // 37: Dekart.UpdateReport:output_type -> UpdateReportResponse
	9,  // 38: Dekart.ArchiveReport:output_type -> ArchiveReportResponse
	27, // 39: Dekart.CreateDataset:output_type -> CreateDatasetResponse
	4,  // 40: Dekart.RemoveDataset:output_type -> RemoveDatasetResponse
	29, // 41: Dekart.CreateFile:output_type -> CreateFileResponse
	31, // 42: Dekart.CreateQuery:output_type -> CreateQueryResponse
	25, // 43: Dekart.UpdateQuery:output_type -> UpdateQueryResponse
	19, // 44: Dekart.RunQuery:output_type -> RunQueryResponse
	23, // 45: Dekart.CancelQuery:output_type -> CancelQueryResponse
	21, // 46: Dekart.RemoveQuery:output_type -> RemoveQueryResponse
	7,  // 47: Dekart.GetEnv:output_type -> GetEnvResponse
	33, // 48: Dekart.GetReportStream:output_type -> ReportStreamResponse
	11, // 49: Dekart.GetReportListStream:output_type -> ReportListResponse
