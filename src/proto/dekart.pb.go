...
var file_proto_dekart_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x22, 0xa4, 0x05, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f,
	...
	0x6c, 0x61, 0x6b, 0x65, 0x57, 0x61, 0x72, 0x65, 0x68, 0x6f, 0x75, 0x73, 0x65, 0x12, 0x2a, 0x0a,
	0x0c, 0x62, 0x69, 0x67, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x10, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x52, 0x0b, 0x62, 0x69,
	0x67, 0x71, 0x75, 0x65, 0x72, 0x79, 0x4b, 0x65, 0x79, 0x22, 0x76, 0x0a, 0x06, 0x53, 0x65, 0x63,
	...
	0x74, 0x45, 0x6e, 0x76, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xc0, 0x05, 0x0a, 0x0e,
	...
	0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x1a, 0xf5, 0x04, 0x0a, 0x08, 0x56, 0x61, 0x72, 0x69, 0x61,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x9f, 0x04, 0x0a,
	...
	0x44, 0x5f, 0x43, 0x4f, 0x4e, 0x4e, 0x45, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x13, 0x22, 0x7e,
	...
	0x65, 0x61, 0x6d, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x0d, 0x73, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x8c, 0x04, 0x0a, 0x06, 0x52, 0x65,
	...
	0x69, 0x73, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x12, 0x2e, 0x0a, 0x0c, 0x71, 0x75, 0x65, 0x72,
	0x79, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0b,
	...
	0x57, 0x46, 0x4c, 0x41, 0x4b, 0x45, 0x10, 0x02, 0x32, 0xbe, 0x12, 0x0a, 0x06, 0x44, 0x65, 0x6b,
...
var file_proto_dekart_proto_depIdxs = []int32{
	...
	54, // 24: Connection.bigquery_key:type_name -> Secret
	96, // 25: GetEnvResponse.variables:type_name -> GetEnvResponse.Variable
	6,  // 26: AuthState.action:type_name -> AuthState.Action
	61, // 27: ReportListRequest.stream_options:type_name -> StreamOptions
	70, // 28: ReportListResponse.reports:type_name -> Report
	61, // 29: ReportListResponse.stream_options:type_name -> StreamOptions
	95, // 30: Report.query_params:type_name -> QueryParam
	...
	73, // 35: UpdateReportRequest.query:type_name -> Query
	95, // 36: UpdateReportRequest.query_params:type_name -> QueryParam
	95, // 37: RunQueryRequest.query_params:type_name -> QueryParam
	73, // 38: CreateQueryResponse.query:type_name -> Query
	70, // 39: ReportStreamRequest.report:type_name -> Report
	61, // 40: ReportStreamRequest.stream_options:type_name -> StreamOptions
	70, // 41: ReportStreamResponse.report:type_name -> Report
	73, // 42: ReportStreamResponse.queries:type_name -> Query
	61, // 43: ReportStreamResponse.stream_options:type_name -> StreamOptions
	71, // 44: ReportStreamResponse.datasets:type_name -> Dataset
	74, // 45: ReportStreamResponse.files:type_name -> File
	72, // 46: ReportStreamResponse.query_jobs:type_name -> QueryJob
	70, // 47: CreateReportResponse.report:type_name -> Report
	10, // 48: QueryParam.type:type_name -> QueryParam.Type
	5,  // 49: GetEnvResponse.Variable.type:type_name -> GetEnvResponse.Variable.Type
	93, // 50: Dekart.CreateReport:input_type -> CreateReportRequest
	91, // 51: Dekart.ForkReport:input_type -> ForkReportRequest
	75, // 52: Dekart.UpdateReport:input_type -> UpdateReportRequest
	66, // 53: Dekart.ArchiveReport:input_type -> ArchiveReportRequest
	57, // 54: Dekart.SetDiscoverable:input_type -> SetDiscoverableRequest
	83, // 55: Dekart.CreateDataset:input_type -> CreateDatasetRequest
	59, // 56: Dekart.RemoveDataset:input_type -> RemoveDatasetRequest
	79, // 57: Dekart.UpdateDatasetName:input_type -> UpdateDatasetNameRequest
	81, // 58: Dekart.UpdateDatasetConnection:input_type -> UpdateDatasetConnectionRequest
	85, // 59: Dekart.CreateFile:input_type -> CreateFileRequest
	87, // 60: Dekart.CreateQuery:input_type -> CreateQueryRequest
	77, // 61: Dekart.RunQuery:input_type -> RunQueryRequest
	35, // 62: Dekart.RunAllQueries:input_type -> RunAllQueriesRequest
	11, // 63: Dekart.CancelJob:input_type -> CancelJobRequest
	62, // 64: Dekart.GetEnv:input_type -> GetEnvRequest
	89, // 65: Dekart.GetReportStream:input_type -> ReportStreamRequest
	68, // 66: Dekart.GetReportListStream:input_type -> ReportListRequest
	43, // 67: Dekart.GetUserStream:input_type -> GetUserStreamRequest
	55, // 68: Dekart.GetUsage:input_type -> GetUsageRequest
	51, // 69: Dekart.CreateConnection:input_type -> CreateConnectionRequest
	31, // 70: Dekart.GetGcpProjectList:input_type -> GetGcpProjectListRequest
	49, // 71: Dekart.UpdateConnection:input_type -> UpdateConnectionRequest
	47, // 72: Dekart.ArchiveConnection:input_type -> ArchiveConnectionRequest
	41, // 73: Dekart.GetConnectionList:input_type -> GetConnectionListRequest
	45, // 74: Dekart.TestConnection:input_type -> TestConnectionRequest
	33, // 75: Dekart.SetDefaultConnection:input_type -> SetDefaultConnectionRequest
	25, // 76: Dekart.RespondToInvite:input_type -> RespondToInviteRequest
	39, // 77: Dekart.CreateSubscription:input_type -> CreateSubscriptionRequest
	15, // 78: Dekart.GetStripePortalSession:input_type -> GetStripePortalSessionRequest
	21, // 79: Dekart.CreateWorkspace:input_type -> CreateWorkspaceRequest
	23, // 80: Dekart.UpdateWorkspace:input_type -> UpdateWorkspaceRequest
	19, // 81: Dekart.GetWorkspace:input_type -> GetWorkspaceRequest
	17, // 82: Dekart.UpdateWorkspaceUser:input_type -> UpdateWorkspaceUserRequest
	13, // 83: Dekart.PublishReport:input_type -> PublishReportRequest
	94, // 84: Dekart.CreateReport:output_type -> CreateReportResponse
	92, // 85: Dekart.ForkReport:output_type -> ForkReportResponse
	76, // 86: Dekart.UpdateReport:output_type -> UpdateReportResponse
	67, // 87: Dekart.ArchiveReport:output_type -> ArchiveReportResponse
	58, // 88: Dekart.SetDiscoverable:output_type -> SetDiscoverableResponse
	84, // 89: Dekart.CreateDataset:output_type -> CreateDatasetResponse
	60, // 90: Dekart.RemoveDataset:output_type -> RemoveDatasetResponse
	80, // 91: Dekart.UpdateDatasetName:output_type -> UpdateDatasetNameResponse
	82, // 92: Dekart.UpdateDatasetConnection:output_type -> UpdateDatasetConnectionResponse
	86, // 93: Dekart.CreateFile:output_type -> CreateFileResponse
	88, // 94: Dekart.CreateQuery:output_type -> CreateQueryResponse
	78, // 95: Dekart.RunQuery:output_type -> RunQueryResponse
	36, // 96: Dekart.RunAllQueries:output_type -> RunAllQueriesResponse
	12, // 97: Dekart.CancelJob:output_type -> CancelJobResponse
	63, // 98: Dekart.GetEnv:output_type -> GetEnvResponse
	90, // 99: Dekart.GetReportStream:output_type -> ReportStreamResponse
	69, // 100: Dekart.GetReportListStream:output_type -> ReportListResponse
	44, // 101: Dekart.GetUserStream:output_type -> GetUserStreamResponse
	56, // 102: Dekart.GetUsage:output_type -> GetUsageResponse
	52, // 103: Dekart.CreateConnection:output_type -> CreateConnectionResponse
	32, // 104: Dekart.GetGcpProjectList:output_type -> GetGcpProjectListResponse
	50, // 105: Dekart.UpdateConnection:output_type -> UpdateConnectionResponse
	48, // 106: Dekart.ArchiveConnection:output_type -> ArchiveConnectionResponse
	42, // 107: Dekart.GetConnectionList:output_type -> GetConnectionListResponse
	46, // 108: Dekart.TestConnection:output_type -> TestConnectionResponse
	34, // 109: Dekart.SetDefaultConnection:output_type -> SetDefaultConnectionResponse
	26, // 110: Dekart.RespondToInvite:output_type -> RespondToInviteResponse
	40, // 111: Dekart.CreateSubscription:output_type -> CreateSubscriptionResponse
	16, // 112: Dekart.GetStripePortalSession:output_type -> GetStripePortalSessionResponse
	22, // 113: Dekart.CreateWorkspace:output_type -> CreateWorkspaceResponse
	24, // 114: Dekart.UpdateWorkspace:output_type -> UpdateWorkspaceResponse
	20, // 115: Dekart.GetWorkspace:output_type -> GetWorkspaceResponse
	18, // 116: Dekart.UpdateWorkspaceUser:output_type -> UpdateWorkspaceUserResponse
	14, // 117: Dekart.PublishReport:output_type -> PublishReportResponse
