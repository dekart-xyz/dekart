...
var file_proto_dekart_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1a, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x47, 0x63, 0x70, 0x50, 0x72,
	...
	0x49, 0x64, 0x22, 0x17, 0x0a, 0x15, 0x52, 0x75, 0x6e, 0x41, 0x6c, 0x6c, 0x51, 0x75, 0x65, 0x72,
	0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1a, 0x0a, 0x18, 0x47,
	...
	0xf4, 0x02, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0e,
	...
	0x65, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x11, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x61,
	...
	0x22, 0xe4, 0x04, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x45, 0x6e, 0x76, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x52, 0x09, 0x76, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x1a, 0x99, 0x04, 0x0a, 0x08,
	...
	0x65, 0x22, 0xc3, 0x03, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x14, 0x0a, 0x10, 0x54, 0x59,
	...
	0x59, 0x5f, 0x53, 0x51, 0x4c, 0x10, 0x0f, 0x22, 0x44, 0x0a, 0x0d, 0x52, 0x65, 0x64, 0x69, 0x72,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xf4, 0x02,
	...
	0x6f, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x52, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x52, 0x06, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x32, 0xe9, 0x0d, 0x0a, 0x06, 0x44,
...
var file_proto_dekart_proto_depIdxs = []int32{
	...
	23, // 6: CreateConnectionResponse.connection:type_name -> Connection
	65, // 7: GetEnvResponse.variables:type_name -> GetEnvResponse.Variable
	1,  // 8: AuthState.action:type_name -> AuthState.Action
	30, // 9: ReportListRequest.stream_options:type_name -> StreamOptions
	39, // 10: ReportListResponse.reports:type_name -> Report
	30, // 11: ReportListResponse.stream_options:type_name -> StreamOptions
	...
	41, // 16: UpdateReportRequest.query:type_name -> Query
	41, // 17: CreateQueryResponse.query:type_name -> Query
	39, // 18: ReportStreamRequest.report:type_name -> Report
	30, // 19: ReportStreamRequest.stream_options:type_name -> StreamOptions
	39, // 20: ReportStreamResponse.report:type_name -> Report
	41, // 21: ReportStreamResponse.queries:type_name -> Query
	30, // 22: ReportStreamResponse.stream_options:type_name -> StreamOptions
	40, // 23: ReportStreamResponse.datasets:type_name -> Dataset
	42, // 24: ReportStreamResponse.files:type_name -> File
	23, // 25: ReportStreamResponse.connections:type_name -> Connection
	39, // 26: CreateReportResponse.report:type_name -> Report
	0,  // 27: GetEnvResponse.Variable.type:type_name -> GetEnvResponse.Variable.Type
	63, // 28: Dekart.CreateReport:input_type -> CreateReportRequest
	61, // 29: Dekart.ForkReport:input_type -> ForkReportRequest
	43, // 30: Dekart.UpdateReport:input_type -> UpdateReportRequest
	35, // 31: Dekart.ArchiveReport:input_type -> ArchiveReportRequest
	26, // 32: Dekart.SetDiscoverable:input_type -> SetDiscoverableRequest
	53, // 33: Dekart.CreateDataset:input_type -> CreateDatasetRequest
	28, // 34: Dekart.RemoveDataset:input_type -> RemoveDatasetRequest
	49, // 35: Dekart.UpdateDatasetName:input_type -> UpdateDatasetNameRequest
	51, // 36: Dekart.UpdateDatasetConnection:input_type -> UpdateDatasetConnectionRequest
	55, // 37: Dekart.CreateFile:input_type -> CreateFileRequest
	57, // 38: Dekart.CreateQuery:input_type -> CreateQueryRequest
	45, // 39: Dekart.RunQuery:input_type -> RunQueryRequest
	47, // 40: Dekart.CancelQuery:input_type -> CancelQueryRequest
	9,  // 41: Dekart.RunAllQueries:input_type -> RunAllQueriesRequest
	31, // 42: Dekart.GetEnv:input_type -> GetEnvRequest
	59, // 43: Dekart.GetReportStream:input_type -> ReportStreamRequest
	37, // 44: Dekart.GetReportListStream:input_type -> ReportListRequest
	13, // 45: Dekart.GetUserStream:input_type -> GetUserStreamRequest
	24, // 46: Dekart.GetUsage:input_type -> GetUsageRequest
	21, // 47: Dekart.CreateConnection:input_type -> CreateConnectionRequest
	5,  // 48: Dekart.GetGcpProjectList:input_type -> GetGcpProjectListRequest
	19, // 49: Dekart.UpdateConnection:input_type -> UpdateConnectionRequest
	17, // 50: Dekart.ArchiveConnection:input_type -> ArchiveConnectionRequest
	11, // 51: Dekart.GetConnectionList:input_type -> GetConnectionListRequest
	15, // 52: Dekart.TestConnection:input_type -> TestConnectionRequest
	7,  // 53: Dekart.SetDefaultConnection:input_type -> SetDefaultConnectionRequest
	64, // 54: Dekart.CreateReport:output_type -> CreateReportResponse
	62, // 55: Dekart.ForkReport:output_type -> ForkReportResponse
	44, // 56: Dekart.UpdateReport:output_type -> UpdateReportResponse
	36, // 57: Dekart.ArchiveReport:output_type -> ArchiveReportResponse
	27, // 58: Dekart.SetDiscoverable:output_type -> SetDiscoverableResponse
	54, // 59: Dekart.CreateDataset:output_type -> CreateDatasetResponse
	29, // 60: Dekart.RemoveDataset:output_type -> RemoveDatasetResponse
	50, // 61: Dekart.UpdateDatasetName:output_type -> UpdateDatasetNameResponse
	52, // 62: Dekart.UpdateDatasetConnection:output_type -> UpdateDatasetConnectionResponse
	56, // 63: Dekart.CreateFile:output_type -> CreateFileResponse
	58, // 64: Dekart.CreateQuery:output_type -> CreateQueryResponse
	46, // 65: Dekart.RunQuery:output_type -> RunQueryResponse
	48, // 66: Dekart.CancelQuery:output_type -> CancelQueryResponse
	10, // 67: Dekart.RunAllQueries:output_type -> RunAllQueriesResponse
	32, // 68: Dekart.GetEnv:output_type -> GetEnvResponse
	60, // 69: Dekart.GetReportStream:output_type -> ReportStreamResponse
	38, // 70: Dekart.GetReportListStream:output_type -> ReportListResponse
	14, // 71: Dekart.GetUserStream:output_type -> GetUserStreamResponse
	25, // 72: Dekart.GetUsage:output_type -> GetUsageResponse
	22, // 73: Dekart.CreateConnection:output_type -> CreateConnectionResponse
	6,  // 74: Dekart.GetGcpProjectList:output_type -> GetGcpProjectListResponse
	20, // 75: Dekart.UpdateConnection:output_type -> UpdateConnectionResponse
	18, // 76: Dekart.ArchiveConnection:output_type -> ArchiveConnectionResponse
	12, // 77: Dekart.GetConnectionList:output_type -> GetConnectionListResponse
	16, // 78: Dekart.TestConnection:output_type -> TestConnectionResponse
	8,  // 79: Dekart.SetDefaultConnection:output_type -> SetDefaultConnectionResponse
