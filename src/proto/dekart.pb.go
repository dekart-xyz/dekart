...
func (AuthState_Action) EnumDescriptor() ([]byte, []int) {
	return file_proto_dekart_proto_rawDescGZIP(), []int{10, 0}
}
...
func (Query_QuerySource) EnumDescriptor() ([]byte, []int) {
	return file_proto_dekart_proto_rawDescGZIP(), []int{17, 1}
}
...
var file_proto_dekart_proto_rawDesc = []byte{
	...
	0xbe, 0x03, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x45, 0x6e, 0x76, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x09, 0x76, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x1a, 0xf3, 0x02, 0x0a, 0x08, 0x56,
	...
	0x22, 0x9d, 0x02, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x14, 0x0a, 0x10, 0x54, 0x59, 0x50,
	...
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xd5, 0x01, 0x0a, 0x09, 0x41, 0x75, 0x74, 0x68, 0x53,
	...
	0x09, 0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x22, 0x53, 0x0a, 0x06, 0x41, 0x63, 0x74,
	...
	0x45, 0x51, 0x55, 0x45, 0x53, 0x54, 0x5f, 0x54, 0x4f, 0x4b, 0x45, 0x4e, 0x10, 0x02, 0x22, 0x4d,
	...
	0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4f, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x52, 0x0d, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4f, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x22, 0xcd, 0x01, 0x0a, 0x06, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x0e, 0x0a,
	...
	0x6c, 0x65, 0x22, 0xbc, 0x01, 0x0a, 0x07, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x12, 0x0e,
	...
	0x65, 0x22, 0xdc, 0x05, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x49, 0x0a, 0x14,
	...
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x32, 0xdb, 0x07, 0x0a, 0x06, 0x44, 0x65, 0x6b, 0x61, 0x72, 0x74,
...
var file_proto_dekart_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_proto_dekart_proto_goTypes = []interface{}{
	...
	(*GetUsageRequest)(nil),           // 5: GetUsageRequest
	(*GetUsageResponse)(nil),          // 6: GetUsageResponse
	(*SetDiscoverableRequest)(nil),    // 7: SetDiscoverableRequest
	(*SetDiscoverableResponse)(nil),   // 8: SetDiscoverableResponse
	(*RemoveDatasetRequest)(nil),      // 9: RemoveDatasetRequest
	(*RemoveDatasetResponse)(nil),     // 10: RemoveDatasetResponse
	(*StreamOptions)(nil),             // 11: StreamOptions
	(*GetEnvRequest)(nil),             // 12: GetEnvRequest
	(*GetEnvResponse)(nil),            // 13: GetEnvResponse
	(*RedirectState)(nil),             // 14: RedirectState
	(*AuthState)(nil),                 // 15: AuthState
	(*ArchiveReportRequest)(nil),      // 16: ArchiveReportRequest
	(*ArchiveReportResponse)(nil),     // 17: ArchiveReportResponse
	(*ReportListRequest)(nil),         // 18: ReportListRequest
	(*ReportListResponse)(nil),        // 19: ReportListResponse
	(*Report)(nil),                    // 20: Report
	(*Dataset)(nil),                   // 21: Dataset
	(*Query)(nil),                     // 22: Query
	(*File)(nil),                      // 23: File
	(*UpdateReportRequest)(nil),       // 24: UpdateReportRequest
	(*UpdateReportResponse)(nil),      // 25: UpdateReportResponse
	(*RunQueryRequest)(nil),           // 26: RunQueryRequest
	(*RunQueryResponse)(nil),          // 27: RunQueryResponse
	(*CancelQueryRequest)(nil),        // 28: CancelQueryRequest
	(*CancelQueryResponse)(nil),       // 29: CancelQueryResponse
	(*UpdateDatasetRequest)(nil),      // 30: UpdateDatasetRequest
	(*UpdateDatasetResponse)(nil),     // 31: UpdateDatasetResponse
	(*CreateDatasetRequest)(nil),      // 32: CreateDatasetRequest
	(*CreateDatasetResponse)(nil),     // 33: CreateDatasetResponse
	(*CreateFileRequest)(nil),         // 34: CreateFileRequest
	(*CreateFileResponse)(nil),        // 35: CreateFileResponse
	(*CreateQueryRequest)(nil),        // 36: CreateQueryRequest
	(*CreateQueryResponse)(nil),       // 37: CreateQueryResponse
	(*ReportStreamRequest)(nil),       // 38: ReportStreamRequest
	(*ReportStreamResponse)(nil),      // 39: ReportStreamResponse
	(*ForkReportRequest)(nil),         // 40: ForkReportRequest
	(*ForkReportResponse)(nil),        // 41: ForkReportResponse
	(*CreateReportRequest)(nil),       // 42: CreateReportRequest
	(*CreateReportResponse)(nil),      // 43: CreateReportResponse
	(*GetEnvResponse_Variable)(nil),   // 44: GetEnvResponse.Variable
}
var file_proto_dekart_proto_depIdxs = []int32{
	44, // 0: GetEnvResponse.variables:type_name -> GetEnvResponse.Variable
	1,  // 1: AuthState.action:type_name -> AuthState.Action
	11, // 2: ReportListRequest.stream_options:type_name -> StreamOptions
	20, // 3: ReportListResponse.reports:type_name -> Report
	11, // 4: ReportListResponse.stream_options:type_name -> StreamOptions
	2,  // 5: Query.job_status:type_name -> Query.JobStatus
	3,  // 6: Query.query_source:type_name -> Query.QuerySource
	4,  // 7: File.file_status:type_name -> File.Status
	20, // 8: UpdateReportRequest.report:type_name -> Report
	22, // 9: UpdateReportRequest.query:type_name -> Query
	22, // 10: CreateQueryResponse.query:type_name -> Query
	20, // 11: ReportStreamRequest.report:type_name -> Report
	11, // 12: ReportStreamRequest.stream_options:type_name -> StreamOptions
	20, // 13: ReportStreamResponse.report:type_name -> Report
	22, // 14: ReportStreamResponse.queries:type_name -> Query
	11, // 15: ReportStreamResponse.stream_options:type_name -> StreamOptions
	21, // 16: ReportStreamResponse.datasets:type_name -> Dataset
	23, // 17: ReportStreamResponse.files:type_name -> File
	20, // 18: CreateReportResponse.report:type_name -> Report
	0,  // 19: GetEnvResponse.Variable.type:type_name -> GetEnvResponse.Variable.Type
	42, // 20: Dekart.CreateReport:input_type -> CreateReportRequest
	40, // 21: Dekart.ForkReport:input_type -> ForkReportRequest
	24, // 22: Dekart.UpdateReport:input_type -> UpdateReportRequest
	16, // 23: Dekart.ArchiveReport:input_type -> ArchiveReportRequest
	7,  // 24: Dekart.SetDiscoverable:input_type -> SetDiscoverableRequest
	32, // 25: Dekart.CreateDataset:input_type -> CreateDatasetRequest
	9,  // 26: Dekart.RemoveDataset:input_type -> RemoveDatasetRequest
	30, // 27: Dekart.UpdateDataset:input_type -> UpdateDatasetRequest
	34, // 28: Dekart.CreateFile:input_type -> CreateFileRequest
	36, // 29: Dekart.CreateQuery:input_type -> CreateQueryRequest
	26, // 30: Dekart.RunQuery:input_type -> RunQueryRequest
	28, // 31: Dekart.CancelQuery:input_type -> CancelQueryRequest
	12, // 32: Dekart.GetEnv:input_type -> GetEnvRequest
	38, // 33: Dekart.GetReportStream:input_type -> ReportStreamRequest
	18, // 34: Dekart.GetReportListStream:input_type -> ReportListRequest
	5,  // 35: Dekart.GetUsage:input_type -> GetUsageRequest
	43, // 36: Dekart.CreateReport:output_type -> CreateReportResponse
	41, // 37: Dekart.ForkReport:output_type -> ForkReportResponse
	25, // 38: Dekart.UpdateReport:output_type -> UpdateReportResponse
	17, // 39: Dekart.ArchiveReport:output_type -> ArchiveReportResponse
	8,  // 40: Dekart.SetDiscoverable:output_type -> SetDiscoverableResponse
	33, // 41: Dekart.CreateDataset:output_type -> CreateDatasetResponse
	10, // 42: Dekart.RemoveDataset:output_type -> RemoveDatasetResponse
	31, // 43: Dekart.UpdateDataset:output_type -> UpdateDatasetResponse
	35, // 44: Dekart.CreateFile:output_type -> CreateFileResponse
	37, // 45: Dekart.CreateQuery:output_type -> CreateQueryResponse
	27, // 46: Dekart.RunQuery:output_type -> RunQueryResponse
	29, // 47: Dekart.CancelQuery:output_type -> CancelQueryResponse
	13, // 48: Dekart.GetEnv:output_type -> GetEnvResponse
	39, // 49: Dekart.GetReportStream:output_type -> ReportStreamResponse
	19, // 50: Dekart.GetReportListStream:output_type -> ReportListResponse
	6,  // 51: Dekart.GetUsage:output_type -> GetUsageResponse
