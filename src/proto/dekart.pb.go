...
func (Query_QuerySource) EnumDescriptor() ([]byte, []int) {
	return file_proto_dekart_proto_rawDescGZIP(), []int{16, 1}
}
...
var file_proto_dekart_proto_rawDesc = []byte{
	...
	0x22, 0xd5, 0x01, 0x0a, 0x09, 0x41, 0x75, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x29,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x75, 0x69, 0x55, 0x72, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x73,
	0x65, 0x63, 0x72, 0x65, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x63,
	0x72, 0x65, 0x74, 0x22, 0x53, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x0a,
	...
	0x5f, 0x54, 0x4f, 0x4b, 0x45, 0x4e, 0x10, 0x02, 0x22, 0x4d, 0x0a, 0x14, 0x41, 0x72, 0x63, 0x68,
	...
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x0d, 0x73,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xcd, 0x01, 0x0a,
	...
	0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x61, 0x62, 0x6c, 0x65, 0x22, 0xbc, 0x01, 0x0a,
	...
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xdc, 0x05, 0x0a, 0x05,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x49, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x65, 0x22, 0x17, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x73,
	0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x33, 0x0a, 0x14, 0x43, 0x72,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x22, 0xd3, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53,
	...
	0x69, 0x6c, 0x65, 0x52, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x30, 0x0a, 0x11, 0x46, 0x6f,
	...
	0xdb, 0x07, 0x0a, 0x06, 0x44, 0x65, 0x6b, 0x61, 0x72, 0x74, 0x12, 0x3d, 0x0a, 0x0c, 0x43, 0x72,
...
var file_proto_dekart_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_proto_dekart_proto_goTypes = []interface{}{
	...
	(*AuthState)(nil),                 // 14: AuthState
	(*ArchiveReportRequest)(nil),      // 15: ArchiveReportRequest
	(*ArchiveReportResponse)(nil),     // 16: ArchiveReportResponse
	(*ReportListRequest)(nil),         // 17: ReportListRequest
	(*ReportListResponse)(nil),        // 18: ReportListResponse
	(*Report)(nil),                    // 19: Report
	(*Dataset)(nil),                   // 20: Dataset
	(*Query)(nil),                     // 21: Query
	(*File)(nil),                      // 22: File
	(*UpdateReportRequest)(nil),       // 23: UpdateReportRequest
	(*UpdateReportResponse)(nil),      // 24: UpdateReportResponse
	(*RunQueryRequest)(nil),           // 25: RunQueryRequest
	(*RunQueryResponse)(nil),          // 26: RunQueryResponse
	(*CancelQueryRequest)(nil),        // 27: CancelQueryRequest
	(*CancelQueryResponse)(nil),       // 28: CancelQueryResponse
	(*UpdateDatasetRequest)(nil),      // 29: UpdateDatasetRequest
	(*UpdateDatasetResponse)(nil),     // 30: UpdateDatasetResponse
	(*CreateDatasetRequest)(nil),      // 31: CreateDatasetRequest
	(*CreateDatasetResponse)(nil),     // 32: CreateDatasetResponse
	(*CreateFileRequest)(nil),         // 33: CreateFileRequest
	(*CreateFileResponse)(nil),        // 34: CreateFileResponse
	(*CreateQueryRequest)(nil),        // 35: CreateQueryRequest
	(*CreateQueryResponse)(nil),       // 36: CreateQueryResponse
	(*ReportStreamRequest)(nil),       // 37: ReportStreamRequest
	(*ReportStreamResponse)(nil),      // 38: ReportStreamResponse
	(*ForkReportRequest)(nil),         // 39: ForkReportRequest
	(*ForkReportResponse)(nil),        // 40: ForkReportResponse
	(*CreateReportRequest)(nil),       // 41: CreateReportRequest
	(*CreateReportResponse)(nil),      // 42: CreateReportResponse
	(*GetEnvResponse_Variable)(nil),   // 43: GetEnvResponse.Variable
}
var file_proto_dekart_proto_depIdxs = []int32{
	43, // 0: GetEnvResponse.variables:type_name -> GetEnvResponse.Variable
	1,  // 1: AuthState.action:type_name -> AuthState.Action
	11, // 2: ReportListRequest.stream_options:type_name -> StreamOptions
	19, // 3: ReportListResponse.reports:type_name -> Report
	...
	19, // 8: UpdateReportRequest.report:type_name -> Report
	21, // 9: UpdateReportRequest.query:type_name -> Query
	21, // 10: CreateQueryResponse.query:type_name -> Query
	19, // 11: ReportStreamRequest.report:type_name -> Report
	11, // 12: ReportStreamRequest.stream_options:type_name -> StreamOptions
	19, // 13: ReportStreamResponse.report:type_name -> Report
	21, // 14: ReportStreamResponse.queries:type_name -> Query
	11, // 15: ReportStreamResponse.stream_options:type_name -> StreamOptions
	20, // 16: ReportStreamResponse.datasets:type_name -> Dataset
	22, // 17: ReportStreamResponse.files:type_name -> File
	19, // 18: CreateReportResponse.report:type_name -> Report
	0,  // 19: GetEnvResponse.Variable.type:type_name -> GetEnvResponse.Variable.Type
	41, // 20: Dekart.CreateReport:input_type -> CreateReportRequest
	39, // 21: Dekart.ForkReport:input_type -> ForkReportRequest
	23, // 22: Dekart.UpdateReport:input_type -> UpdateReportRequest
	15, // 23: Dekart.ArchiveReport:input_type -> ArchiveReportRequest
	7,  // 24: Dekart.SetDiscoverable:input_type -> SetDiscoverableRequest
	31, // 25: Dekart.CreateDataset:input_type -> CreateDatasetRequest
	9,  // 26: Dekart.RemoveDataset:input_type -> RemoveDatasetRequest
	29, // 27: Dekart.UpdateDataset:input_type -> UpdateDatasetRequest
	33, // 28: Dekart.CreateFile:input_type -> CreateFileRequest
	35, // 29: Dekart.CreateQuery:input_type -> CreateQueryRequest
	25, // 30: Dekart.RunQuery:input_type -> RunQueryRequest
	27, // 31: Dekart.CancelQuery:input_type -> CancelQueryRequest
	12, // 32: Dekart.GetEnv:input_type -> GetEnvRequest
	37, // 33: Dekart.GetReportStream:input_type -> ReportStreamRequest
	17, // 34: Dekart.GetReportListStream:input_type -> ReportListRequest
	5,  // 35: Dekart.GetUsage:input_type -> GetUsageRequest
	42, // 36: Dekart.CreateReport:output_type -> CreateReportResponse
	40, // 37: Dekart.ForkReport:output_type -> ForkReportResponse
	24, // 38: Dekart.UpdateReport:output_type -> UpdateReportResponse
	16, // 39: Dekart.ArchiveReport:output_type -> ArchiveReportResponse
	8,  // 40: Dekart.SetDiscoverable:output_type -> SetDiscoverableResponse
	32, // 41: Dekart.CreateDataset:output_type -> CreateDatasetResponse
	10, // 42: Dekart.RemoveDataset:output_type -> RemoveDatasetResponse
	30, // 43: Dekart.UpdateDataset:output_type -> UpdateDatasetResponse
	34, // 44: Dekart.CreateFile:output_type -> CreateFileResponse
	36, // 45: Dekart.CreateQuery:output_type -> CreateQueryResponse
	26, // 46: Dekart.RunQuery:output_type -> RunQueryResponse
	28, // 47: Dekart.CancelQuery:output_type -> CancelQueryResponse
	13, // 48: Dekart.GetEnv:output_type -> GetEnvResponse
	38, // 49: Dekart.GetReportStream:output_type -> ReportStreamResponse
	18, // 50: Dekart.GetReportListStream:output_type -> ReportListResponse
