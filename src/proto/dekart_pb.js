 ...
 * @const
 */
proto.Report.repeatedFields_ = [16];
...
/**
 * repeated QueryParam query_params = 16;
 * @return {!Array<!proto.QueryParam>}
 */
proto.Report.prototype.getQueryParamsList = function() {
  return /** @type{!Array<!proto.QueryParam>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.QueryParam, 16));
};
...
proto.Report.prototype.addQueryParams = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 16, opt_value, proto.QueryParam, opt_index);
};
