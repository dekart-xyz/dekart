 ...
 * @return {string}
 */
proto.RespondToInviteRequest.prototype.getOrganizationId = function() {
 ...
 */
proto.RespondToInviteRequest.prototype.setOrganizationId = function(value) {
 ...
 */
proto.OrganizationInvite.prototype.getOrganization = function() {
...
*/
proto.OrganizationInvite.prototype.setOrganization = function(value) {
 ...
 * @return {!proto.OrganizationInvite} returns this
 */
proto.OrganizationInvite.prototype.clearOrganization = function() {
 ...
 * @return {boolean}
 */
proto.OrganizationInvite.prototype.hasOrganization = function() {
...
proto.GetUserStreamResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    organizationInviteUpdate: jspb.Message.getFieldWithDefault(msg, 106, 0)
  };
...
proto.GetUserStreamResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 106:
      var value = /** @type {number} */ (reader.readInt64());
      msg.setOrganizationInviteUpdate(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.GetUserStreamResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getOrganizationInviteUpdate();
  if (f !== 0) {
    writer.writeInt64(
      106,
      f
...
/**
 * optional int64 organization_invite_update = 106;
 * @return {number}
 */
proto.GetUserStreamResponse.prototype.getOrganizationInviteUpdate = function() {
 ...
 * @return {!proto.GetUserStreamResponse} returns this
 */
proto.GetUserStreamResponse.prototype.setOrganizationInviteUpdate = function(value) {
