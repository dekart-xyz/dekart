...
CREATE TABLE IF NOT EXISTS dataset_snapshots (
  ...
  CONSTRAINT fk_dataset_snapshots_version FOREIGN KEY(report_version_id) REFERENCES report_snapshots(version_id) ON DELETE CASCADE,
  CONSTRAINT fk_dataset_snapshots_report FOREIGN KEY(report_id) REFERENCES reports(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS query_snapshots (
  ...
  CONSTRAINT fk_query_snapshots_version FOREIGN KEY(report_version_id) REFERENCES report_snapshots(version_id) ON DELETE CASCADE,
  CONSTRAINT fk_query_snapshots_report FOREIGN KEY(report_id) REFERENCES reports(id) ON DELETE CASCADE,
...
CREATE INDEX idx_query_snapshots_version ON query_snapshots(report_version_id);
